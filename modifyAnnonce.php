...
<div class="hero-wrap h-1000" style="background-image: url('images/bg_3.jpg')">
    <section class="ftco-section">
        <div class="container">
            <form action="modifyAnnonce_post.php" method="post" class="w-100 mx-auto p-4 mt-5 shadow rounded bg-white"
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <div class="select-wrap one-third">
                            <select class="form-control" name="type">
                                <option value="<?php echo $logement['type'];?>"><?php echo $logement['type'];?></option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?php echo $logement['adress'];?>" name="adress">
                    </div>
                    ...
                    <section class="d-flex">
                        <div class="mb-3 w-50">
                            ...
                            <input type="text" class="form-control" value="<?php echo $logement['city'];?>" name="city">
                        </div>
                        <div class="mb-3 w-50">
                            <label for="cp" class="form-label">Code Postal *</label>
                            <input type="number" class="form-control" value="<?php echo $logement['cp'];?>" name="cp">
                        </div>
                    </section>
                    <div class="mb-3">
                    ...
                    <div class="mb-3 d-flex justify-content-between">
                        ...
                        <div class="w-50">
                            ...
                            <input type="date" class="form-control" value="<?php echo $logement['end'];?>" name="end">
                        </div>
                    </div>
